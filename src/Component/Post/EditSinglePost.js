    ...
    return (
      <div>
        <PostWrapper style={{ position: 'relative' }}>
          ...
          <BUTTONWRAPPER>
            <Button firstColor="#61BBF7" secondColor="#9A4BF5" width="40%">
              EDIT{' '}
            </Button>
          </BUTTONWRAPPER>
          <BUTTONWRAPPER>
            <Button firstColor="#F54B64" secondColor="#F78361" width="20%">
              DELETE{' '}
            </Button>
          </BUTTONWRAPPER>
        </PostWrapper>
...
EditSinglePost.propTypes = { data: PropTypes.object };
